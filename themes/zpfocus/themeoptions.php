...
class ThemeOptions {
	...
	function ThemeOptions() {
		...
		setOptionDefault('zpfocus_social', true);
	...
	function getOptionsSupported() {
		return array(	
						...
						gettext('(5) Allow search') => array('key' => 'zpfocus_allow_search', 'type' => OPTION_TYPE_CHECKBOX, 'desc' => gettext('Check to enable search form.')),
						...
						gettext('(1) Social Links?') => array('key' => 'zpfocus_social', 'type' => OPTION_TYPE_CHECKBOX, 'desc' => gettext('Check to display the social sharing links so users can post your items to their preferred social networks.')),
	...
	function getOptionsDisabled() {
		return array('custom_index_page','thumb_crop','thumb_size');
	}
