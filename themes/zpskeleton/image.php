		...
		<div class="container">
			...
			<div class="ten columns">
				<div class="image-wrap" id="image">
					<?php if ($zpskel_ismobile) { $size = 420; } else { $size = 630; }
		...
		<div class="container">
			<div class="sixteen columns">
				...
				<ul class="taglist rss">
					<?php if (function_exists('printCommentForm')) { ?><li><?php printRSSLink('Comments-image', $prev, gettext('Latest Comments of this Image'),'',false); ?></li><?php } ?>
					<li><?php printRSSLink('Collection', $prev, gettext('Latest Images of this Album'),'',false); ?></li>
					<?php if (function_exists('printCommentForm')) { ?><li><?php printRSSLink('Comments-album', $prev, gettext('Latest Comments of this Album'),'',false); ?></li><?php } ?>
				</ul>
			</div>
		</div>
	</div>
