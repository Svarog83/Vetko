...
if ($zenpage && !isArchive()) {
	...
	$numnews = getNumNews(); if ($numnews > $zpmin_zpsearchcount) $numnews = $zpmas_zpsearchcount;
...
if (!empty($searchdate)) {
	...
	$searchwords .= $searchdate;
		...
		<div id="breadcrumbs">
			<a href="<?php echo $zpmas_homelink; ?>" title="<?php echo gettext("Gallery Index"); ?>"><?php echo gettext("Gallery Index"); ?></a> &raquo; <?php echo gettext("Search"); ?> &rarr; <?php echo $searchwords.' ('.$total.' '.gettext('items').')'; ?>
		</div>
		<div id="wrapper">
			<div id="sidebar">
