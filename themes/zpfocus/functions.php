...
setOption('images_per_row',3,false);
$zenpage = getOption('zp_plugin_zenpage'); 

$zpfocus_social = getOption('zpfocus_social'); if (is_null($zpfocus_social)) $zpfocus_social = true;
...
$zpfocus_cbstyle = getOption('zpfocus_cbstyle'); if (is_null($zpfocus_cbstyle)) $zpfocus_cbstyle = 'style3';	
