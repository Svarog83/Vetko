<?php include ("header.php"); ?>
	...
	<div class="wrapper" id="breadcrumbs">
		<div class="centered">
			<div class="breadcrumbs">
				<div>
					<span><?php printHomeLink('', ' &raquo; '); ?><a href="<?php echo htmlspecialchars(getGalleryIndexURL());?>" title="<?php gettext('Albums Index'); ?>"><?php echo gettext('Home'); ?></a> &raquo; <?php printNewsIndexURL("News",""); ?><?php printCurrentNewsCategory(" &raquo; Category - "); ?><?php printNewsTitle("  &raquo;  "); printCurrentNewsArchive("  &raquo;  "); ?></span>
				</div>
			</div>
		</div>
	</div>
	<div class="wrapper">
		<div class="centered">	
			...
			<?php if(getPrevNewsURL()) { ?><div id="navbar-prev"><?php printPrevNewsLink('&lsaquo;'); ?></div><?php } ?>
			<?php if(getNextNewsURL()) { ?><div id="navbar-next"><?php printNextNewsLink('&rsaquo;'); ?></div><?php } ?>
			<?php } ?>
			...
			<div class="paging">
				<?php printNewsPageListWithNav( gettext('Next &rsaquo;'),gettext('&lsaquo; Previous'),true,'' ); ?>
			</div>
			<?php } ?> 
		</div>
	</div>
