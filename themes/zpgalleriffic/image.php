<?php include ("header.php"); ?>
	...
	<div class="wrapper" id="breadcrumbs">
		<div class="centered">
			<div class="breadcrumbs">
				...
				<div>
					<?php printHomeLink('', ' &raquo; '); ?><a href="<?php echo htmlspecialchars(getGalleryIndexURL());?>" title="<?php gettext('Albums Index'); ?>"><?php echo gettext('Home');?></a> &raquo; <?php printParentBreadcrumb("", " &raquo; ", " &raquo; "); printAlbumBreadcrumb("", " &raquo; "); ?></span> <?php printImageTitle(true); ?>
				</div>
			</div>
		</div>
	</div>
	<div class="wrapper">
		<div class="centered">
			<div id="container">	
				<div id="img-sidebar">
					<div class="image-title"><?php printImageTitle(true); ?></div>
					<div class="img-date"><?php printImageDate('','',null,true); ?></div>
					<div class="img-desc"><?php printImageDesc( true,'',gettext('(Edit Description...)') ); ?></div>
