<?php include ("inc-header.php"); ?>
		...
		<div id="breadcrumbs">
			<a href="<?php echo $zpmas_homelink; ?>" title="<?php echo gettext("Gallery Index"); ?>"><?php echo gettext("Gallery Index"); ?></a> &raquo; <?php printNewsIndexURL("News",""); ?><?php printCurrentNewsCategory(" &raquo; Category &rarr; "); ?><?php printNewsTitle("  &raquo;  "); printCurrentNewsArchive("  &raquo;  "); ?>
		</div>
		<div id="wrapper">
			<div id="sidebar">
				<div id="sidebar-inner">
					<div id="sidebar-padding">
						...
						<div class="latest sidebar-divide">
							...
							<?php printLatestZenpageComments(1); ?>
							<?php printLatestComments(1); ?>
						</div>
						<?php } ?>
			...
			<div id="page">
				<div id="post">
					...
					<div class="news-truncate box"> 
						...
						<?php echo preg_replace("/<img[^>]+\>/i", " [image removed] ", getNewsContent()); printCodeblock(1); ?>
					</div>	
					<?php endwhile; ?>
					</div>
				</div>
